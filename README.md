...
<<<<<<< HEAD
## Javascript Assignments  [![Build Status](https://travis-ci.org/dm-grinko/rolling-scopes-js-assignments.svg?branch=master)](https://travis-ci.org/dm-grinko/rolling-scopes-js-assignments)
=======
...
* Edit local README.md file and update all links (just replace all occurences of `'dm-grinko'` with your account name).
=======
...
```
<<<<<<< HEAD
* Open https://github.com/dm-grinko/rolling-scopes-js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
=======
...
<<<<<<< HEAD
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/dm-grinko/rolling-scopes-js-assignments/builds).
=======
